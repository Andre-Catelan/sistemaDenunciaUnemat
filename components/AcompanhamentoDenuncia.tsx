    ...
    <div className="relative flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark">
      <header className="flex items-center justify-between whitespace-nowrap border-b border-slate-200 dark:border-slate-800 px-4 sm:px-6 lg:px-8 py-3 bg-white dark:bg-background-dark/50 backdrop-blur-sm sticky top-0 z-10">
        <div className="flex items-center gap-4 text-slate-900 dark:text-white">
          ...
          <h1 className="text-slate-900 dark:text-white text-lg font-bold">Sistema de Canal de Denúncias</h1>
        </div>
        <button onClick={goHome} className="flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white text-sm font-bold leading-normal tracking-wide hover:bg-primary/90 transition-colors">
          <span className="truncate">Sair com segurança</span>
        </button>
      </header>
      <main className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <p className="text-slate-900 dark:text-white text-4xl font-black tracking-tight">Acompanhamento da sua Denúncia</p>
        </div>
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24">
              <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm p-6">
                <h2 className="text-slate-900 dark:text-white text-xl font-bold mb-4">Status da sua Denúncia</h2>
                <p className="text-slate-600 dark:text-slate-400 text-base mb-4">Protocolo: <span className="font-semibold text-slate-800 dark:text-slate-200">#12345-67890</span></p>
                <div className="flex flex-wrap gap-2 mb-4">
                  <div className="flex h-8 shrink-0 items-center justify-center gap-x-2 rounded-full bg-amber-500/10 px-3">
                ...
                <div className="mt-6 p-4 rounded-lg bg-primary/10 border border-primary/20">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-bold text-primary">Ambiente Seguro</h3>
                      <p className="text-sm text-primary/80 dark:text-primary/90 mt-1">Sua identidade está protegida. A comunicação neste canal é confidencial e anônima.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-slate-900/50 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
              <div className="p-6 border-b border-slate-200 dark:border-slate-800">
                <h2 className="text-slate-900 dark:text-white text-xl font-bold">Histórico de Comunicação</h2>
              </div>
              <div className="p-6 space-y-6">
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 size-10 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                    <span className="material-symbols-outlined text-slate-500 dark:text-slate-400">support_agent</span>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    <div className="flex items-baseline justify-between">
                      <p className="font-bold text-slate-800 dark:text-slate-200">Você</p>
              ...
              <div className="p-6 border-t border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-background-dark rounded-b-xl">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <button className="inline-flex items-center justify-center gap-2 rounded-lg border border-transparent bg-primary px-4 py-2 text-sm font-bold text-white shadow-sm hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark" type="submit">
                      Enviar Mensagem
