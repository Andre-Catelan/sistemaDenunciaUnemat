      ...
      <header className="sticky top-0 z-10 w-full bg-surface-light/80 dark:bg-surface-dark/80 backdrop-blur-sm border-b border-border-light dark:border-border-dark">
        <div className="container mx-auto flex items-center justify-between whitespace-nowrap px-4 py-3">
          ...
          <div className="hidden md:flex flex-1 justify-center gap-8">
            <a href="#" className="text-sm font-medium leading-normal">Dashboard</a>
            <a href="#" className="text-primary text-sm font-medium leading-normal">Denúncias</a>
      ...
      <main className="flex-1 w-full container mx-auto p-4 md:p-6 lg:p-8">
        <div className="flex flex-col gap-6">
          <div className="flex flex-wrap gap-2">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); navigateBack(); }} className="text-text-muted-light dark:text-text-muted-dark text-sm font-medium leading-normal hover:text-primary">Denúncias</a>
            <span className="text-text-muted-light dark:text-text-muted-dark text-sm font-medium leading-normal">/</span>
            ...
            <aside className="lg:col-span-1 flex flex-col gap-6">
              <div className="rounded-xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark p-6 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <button className="w-full h-10 flex items-center justify-center rounded-lg bg-primary text-white text-sm font-bold leading-normal tracking-[0.015em] hover:bg-primary/90 disabled:bg-gray-400 dark:disabled:bg-gray-600 disabled:cursor-not-allowed">Salvar Alterações</button>
                </div>
                <div className="border-t border-border-light dark:border-border-dark pt-4 flex flex-col gap-3 text-sm">
                  ...
                  <div className="flex justify-between"><span className="text-text-muted-light dark:text-text-muted-dark">Unidade Responsável:</span><span className="font-medium">UN-SP-01</span></div>
            ...
            <div className="lg:col-span-2 rounded-xl border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark">
              ...
              <div className="p-6 flex flex-col gap-6">
                {activeTab === 'messages' && (
                  <>
                    <div className="flex flex-col gap-4">
                      <div className="flex gap-3"><div className="size-10 rounded-full bg-primary/20 flex-shrink-0 flex items-center justify-center"><span className="material-symbols-outlined text-primary">person</span></div><div className="flex-1 rounded-xl rounded-tl-none bg-background-light dark:bg-background-dark p-4"><div className="flex justify-between items-center mb-1"><p className="font-bold text-sm">Denunciante</p><p className="text-xs text-text-muted-light dark:text-text-muted-dark">25/07/2024 10:30</p></div><p className="text-sm">Envio os detalhes do ocorrido. O produto chegou danificado na embalagem original, que estava intacta.</p></div></div>
                      <div className="flex gap-3"><div className="flex-1 rounded-xl rounded-tr-none bg-primary/10 dark:bg-primary/20 p-4 text-right"><div className="flex justify-between items-center mb-1"><p className="text-xs text-text-muted-light dark:text-text-muted-dark">25/07/2024 11:15</p><p className="font-bold text-sm">Agente do Sistema</p></div><p className="text-sm">Recebemos sua denúncia. Poderia, por favor, nos enviar fotos do produto e da nota fiscal para análise?</p></div><div className="size-10 rounded-full bg-gray-200 dark:bg-gray-700 flex-shrink-0 flex items-center justify-center"><span className="material-symbols-outlined text-gray-600 dark:text-gray-300">support_agent</span></div></div>
                      <div className="flex gap-3"><div className="size-10 rounded-full bg-primary/20 flex-shrink-0 flex items-center justify-center"><span className="material-symbols-outlined text-primary">person</span></div><div className="flex-1 rounded-xl rounded-tl-none bg-background-light dark:bg-background-dark p-4"><div className="flex justify-between items-center mb-1"><p className="font-bold text-sm">Denunciante</p><p className="text-xs text-text-muted-light dark:text-text-muted-dark">26/07/2024 09:00</p></div><p className="text-sm">Claro, acabei de adicionar os arquivos na seção de anexos. Obrigado.</p></div></div>
                    </div>
                ...
                {activeTab === 'attachments' && (
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center justify-between p-3 rounded-lg bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark">
                      <div className="flex items-center gap-3"><span className="material-symbols-outlined text-xl text-text-muted-light dark:text-text-muted-dark">draft</span><div className="flex flex-col"><p className="font-medium text-sm">Nota_Fiscal_Compra.pdf</p><p className="text-xs text-text-muted-light dark:text-text-muted-dark">Enviado em 26/07/2024</p></div></div>
                    ...
                    <div className="flex items-center justify-between p-3 rounded-lg bg-background-light dark:bg-background-dark border border-border-light dark:border-border-dark">
                      <div className="flex items-center gap-3"><span className="material-symbols-outlined text-xl text-text-muted-light dark:text-text-muted-dark">image</span><div className="flex flex-col"><p className="font-medium text-sm">Foto_Produto_Defeituoso.jpg</p><p className="text-xs text-text-muted-light dark:text-text-muted-dark">Enviado em 26/07/2024</p></div></div>
                      <button className="flex h-9 w-9 cursor-pointer items-center justify-center overflow-hidden rounded-lg hover:bg-primary/10"><span className="material-symbols-outlined text-lg text-primary">download</span></button>
                    </div>
                  </div>
                )}
